...
Install DHCP Server pada MOJOKERTO dengan perintah ```apt-get install isc-dhcp-server```. Kemudian, buka konfigurasi interface dengan perintah ```nano /etc/default/isc-dhcp-server```.
